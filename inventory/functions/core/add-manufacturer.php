...
if (isset($_POST['add']) && !empty($_POST['add'])) {
    ...
    $man_id = 'M' . str_pad(mt_rand(0, 999999), 6, '0', STR_PAD_LEFT);

    if (empty(array_filter($errors))) {
        $stmt4 = $con->prepare("INSERT INTO `manufacturers`(`id`,`first_name`,`middle_name`,`last_name`,`company_name`,`is_company`,`phone`,`mobile`,`fax`,`email`,`website`,`other`,`notes`,`street`,`city`,`state`,`postal`,`country`,`acc_num`,`created_time`,`last_modification`,`status`) VALUES ('$man_id','$fname','$mname','$lname','$cname','$type','$phone','$mobile','$fax','$email','$website','$other','$notes','$street','$city','$state','$postal','$country','$acc_num','$cdate','$lmodification','$status')");
        $stmt4->execute();
