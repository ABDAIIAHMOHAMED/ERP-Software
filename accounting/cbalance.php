  ...
  if (check_id('cbalances')) {
    ...
    if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7003) == 1) {
      if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7005) == 1) {
        import_trans("cbalance_transactions");
      }
      if (!check_balance('cbalance_transactions', $info['id'])) {
        if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7004) == 1) {
          delete_balance("cbalances");
        }
      }
      if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7006) == 1) {
        delete_trans("cbalance_transactions");
      }
?>
      ...
      <div class="att-part vat-part">
        ...
        <div class="title-head">
          <div class="headso">
            ...
            <hr class="head-line">
            <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / <a href="<?= $path . "cbalances.php" ?>">Credit Balances</a>
          ...
          <div class="btns">
            ...
            ?>
              <?php if (!check_balance('cbalance_transactions', $info['id'])) { ?>
          ...
          <form class="" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="custom-form custom-item-form payment_form">
              <div class="inputs w100 radio_type">
                <label for="fund"><input type="radio" id="fund" name="type" value="1" class="fund" required checked><span class="radio_label fund">Credit</span></label>
                <label for="withdraw"><input type="radio" id="withdraw" name="type" value="2" required><span class="radio_label withdraw">Debit</span></label>
              </div>
