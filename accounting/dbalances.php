    ...
    <div class="att-part vat-part">
      <div class="title-head">
        <div class="headso">
          ...
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Debit Balanaces</p>
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('<html><head><title>Other Debit Balances</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Other Debit Balances</h3><span class="dt-range">From <span class="bold">' + $("#create-date-filter").val() + '</span>  To <span class="bold">' + $("#end-date-filter").val() + '</span></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
        ...
        $('#new_supplier').submit(function(event) {
          ...
          $.ajax({
            type: 'POST',
            url: 'functions/core/add-dbalance.php',
            data: $(this).serialize(),
