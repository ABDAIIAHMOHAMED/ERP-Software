<?php
$pg_name = "Wonder - Credit Balances";
session_start();
include "includes/header.inc";
if (login_redirect() == 1) {
  $user_info = login_info();
  if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7001) == 1) {
    ...
    <div class="att-part vat-part">
      <div class="title-head">
        <div class="headso">
          ...
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Credit Balanaces</p>
        </div>
        ...
        <div class="btns">
          ...
          <?php if (check_user_role(1) == 1 || check_user_role(7000) == 1 || check_user_role(7002) == 1) {
          ?>
            <button class="new-btn">New Balance</button>
          <?php
          }
          ?>
        </div>
          ...
          <div class="custom-form">
            <div class="form-section">
              ...
              <div class="inputs gd6">
                ...
                <input type="date" class="" name="cdate" id="cdate" value="<?= date("Y-m-d") ?>" required>
                <span class="error-field"></span>
              </div>
            </div>
          </div>
      ...
      $(document).ready(function() {
        ...
        var table = $('#supplierslist').DataTable({
          ...
          "footerCallback": function(row, data, start, end, display) {
            ...
            var colIndex2 = 4; // Set the index of the first column to calculate the sum for
            var colIndex3 = 5; // Set the index of the first column to calculate the sum for
            var colIndex4 = 2; // Set the index of the first column to calculate the sum for
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('<html><head><title>Other Credit Balances</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Other Credit Balances</h3><span class="dt-range">From <span class="bold">' + $("#create-date-filter").val() + '</span>  To <span class="bold">' + $("#end-date-filter").val() + '</span></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
        ...
        $('#new_supplier').submit(function(event) {
          ...
          $.ajax({
            type: 'POST',
            url: 'functions/core/add-cbalance.php',
            data: $(this).serialize(),
