<?php
$pg_name = "Wonder - Manufacturers Trial Balance";
session_start();
include "includes/header.inc";
if (login_redirect() == 1) {
  $user_info = login_info();
  if (check_user_role(1) == 1 || check_user_role(1000) == 1 || check_user_role(1003) == 1) {
...
?>
    ...
    <div class="att-part vat-part">
      <div class="title-head">
        <div class="headso">
          <h3>Manufacturers Trial balance
          ...
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Manufacturers Trial Balanace</p>
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        var table = $('#supplierslist').DataTable({
          ajax: {
            url: 'json/trial_manufacturers.php',
            type: 'GET',
            dataSrc: '',
            data: {
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('<html><head><title>Manufacturer Trial Balance</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Manufacturer Trial Balance</h3><span class="dt-range">From <span class="bold">' + $("#create-date-filter").val() + '</span>  To <span class="bold">' + $("#end-date-filter").val() + '</span></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
