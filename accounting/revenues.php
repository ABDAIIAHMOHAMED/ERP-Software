<?php
$pg_name = "Wonder - Revenues";
session_start();
include "includes/header.inc";
if (login_redirect() == 1) {
  if (check_user_role(1) == 1 || check_user_role(8000) == 1 || check_user_role(8001) == 1) {
    $user_info = login_info();
    import_revenue();
    if (check_user_role(1) == 1 || check_user_role(8000) == 1 || check_user_role(8003) == 1) {
      delete_revenue();
    }
?>
    ...
    <div class="att-part vat-part">
      <div class="title-head">
        <div class="headso">
          ...
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Other Revenues</p>
        </div>
        ...
        <div class="btns">
          ...
          <?php if (check_user_role(1) == 1 || check_user_role(8000) == 1 || check_user_role(8002) == 1) {
          ?>
            <button class="new-btn" id="payment-btn">New Revenue</button>
          <?php
          }
          ?>
        </div>
      ...
      <div class="confirm_delete_page">
        <div class="custome-head">
          <h3>Are you sure to cancel revenue #<span class="order_id_confirm">...</span></h3>
        ...
        <form class="" action="" method="POST" enctype="multipart/form-data">
          <div class="custom-form custom-item-form payment_form">
            <div class="inputs w50">
              <label for="expense_type">Revenue Type</label>
            ...
            <div class="inputs w50">
              <label for="amount_payment_method">Receiving Mehtod</label>
              <select name="amount_payment_method" id="amount_payment_method" required>
                <option value="cash">Cash</option>
                <option value="bank">Bank Account</option>
                <option value="accrued revenue">Accrued Revenues</option>
