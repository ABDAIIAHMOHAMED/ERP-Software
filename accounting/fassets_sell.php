...
if (login_redirect() == 1) {
  ...
  if (check_user_role(1) == 1 || check_user_role(900) == 1 || check_user_role(908) == 1) {
            ...
            <table id="supplierslist" style="width:100% !important;">
              <thead>
                <tr>
                  ...
                  <th>Sale Amount (E£)</th>
                  <th>Total Costs (E£)</th>
                  <th>Exclu. Depreciation (E£)</th>
                  <th>Exclu. Gross Carrying Amount (E£)</th>
                  <th>(Loss)/Profit (E£)</th>
                  <th>Vat Amount (E£)</th>
                  <th>Withholding Tax (E£)</th>
                </tr>
              </thead>
              <tfoot>
                <tr>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('<html><head><title>Fixed Assets Sales</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Fixed Assets Sales</h3><span class="dt-range">From <span class="bold">' + $("#create-date-filter").val() + '</span>  To <span class="bold">' + $("#end-date-filter").val() + '</span></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
