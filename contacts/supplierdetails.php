<?php
$pg_name = "Wonder - Suppliers";
session_start();
include "includes/header.inc";
if (login_redirect() == 1) {
  $user_info = login_info();
  if (check_id('suppliers')) {
    $info = info('suppliers');
    if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(203) == 1) {
      import_supplier_purchase();
      edit_supplier_purchase();
      import_quick_payment();
      delete_order("supplier_orders");
?>
      ...
      <div class="att-part">
        <div class="title-head">
          <div class="headso">
            ...
            <hr class="head-line">
            <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / <a href="<?= $path . "suppliers.php" ?>">Suppliers</a>
              / Supplier Profile</p>
          </div>
        </div>
        <div class="profile-section">
          <div class="profile-head-box">
            ...
            <div class="rt-profile-head">
              <div class="buttons">
                <?php
                if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(204) == 1) {
                ?>
                ...
                <ul class="transactions-list">
                  <?php
                  if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(208) == 1) {
                  ?>
                    <li class="trans-option" id="invoice-btn">Purchase Order</li>
                  <?php } ?>
                  <?php
                  if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(209) == 1) {
                  ?>
              ...
              <div class="dues">
                <div class="due open-dues">
                  ...
                  <span class="due-title">DUE BALANCE</span>
                </div>
          ...
          <ul class="profile-lnks customer">
            <li class="details-lnk  active"><button id="details-lnk">Supplier Details</button></li>
            <?php
            if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(205) == 1) {
            ?>
              <li class="mony-lnk"><button id="mony-lnk">Account Statement</button></li>
            <?php } ?>
            <?php
            if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(206) == 1) {
            ?>
              <li class="transaction-lnk"><button id="transaction-lnk">Orders</button></li>
            <?php } ?>
            <?php
            if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(207) == 1) {
            ?>
              <li class="purchase-lnk"><button id="purchase-lnk">Purchases</button></li>
            <?php } ?>
          </ul>
          <?php
          if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(205) == 1) {
          ?>
            <div class="mony-list listo">
              <h4 class='submarin'>Supplier Account Statement
                <div class="inputs">
              ...
              <script>
                $(function() {
                  ...
                  $("#ExportReporttoPdf2").on("click", function() {
                    ...
                    printWindow.document.write('<html><head><title>' + $(".l-main-prof-info h2").html() + '\'s Orders [Supplier]</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
                    printWindow.document.write('<style>table td:last-child,table th:last-child {display: none;}</style>');
                    printWindow.document.write('<style>@page {size: A4 55% landscape;margin: 0;} </style>');
                    printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>' + $(".l-main-prof-info h2").html() + '\'s Orders [Supplier]</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
                    printWindow.document.write(barcodeDiv.innerHTML);
                    printWindow.document.write('</table><div class="sub_header"><span>Report was created at ' + currentTime + '</span><span>By ' + userDate + '</span></div><div class="copyright-section">© 2023 All rights reserved. Powered by <img src="../images/icon.png" alt="">onder</div></div></body></html>');
                  });
                  ...
                  function printInvoice(invoiceId) {
                    ...
                    printWindow.document.write("<div class='invoice_table selling'>" + $('#inv-edit-list').html() + "</div>");
          ...
          ?>
            <div class="purchase-list listo">
              <h4 class='submarin'>Purchases</h4>
              <div class="btns">
                <button class="filter"><i class="fa-solid fa-filter"></i></button>
                <button class="export"><i class="fa-solid fa-download"></i>
                  <ul class="export-options">
                    ...
                    <li class="option btn-print" id="ExportReporttoExcel3">
                      <div><i class="fa-solid fa-file-csv"></i> Excel Sheet</div>
                    </li>
                  </ul>
                </button>
                ...
                $(function() {
                  ...
                  var table3 = $('#supplierpurch').DataTable({
                    ...
                    buttons: [{
                      ...
                      filename: $(".l-main-prof-info h2").html() + '\'s Purchases', // Set the desired filename
                    }],
                    "lengthMenu": [
                      [10, 25, 50, 100, -1],
                      [10, 25, 50, 100, "All"]
                  ...
                  $("#ExportReporttoPdf3").on("click", function() {
                    ...
                    printWindow.document.write('<html><head><title>' + $(".l-main-prof-info h2").html() + '\'s Purchases [Supplier]</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
                    printWindow.document.write('<style>table td:last-child,table th:last-child {display: none;}</style>');
                    printWindow.document.write('<style>@page {size: A4 55% landscape;margin: 0;} </style>');
                    printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>' + $(".l-main-prof-info h2").html() + '\'s Purchases [Supplier]</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
                    printWindow.document.write(barcodeDiv.innerHTML);
                    printWindow.document.write('</table><div class="sub_header"><span>Report was created at ' + currentTime + '</span><span>By ' + userDate + '</span></div><div class="copyright-section">© 2023 All rights reserved. Powered by <img src="../images/icon.png" alt="">onder</div></div></body></html>');
                  });
                  $('select#stock').on('change', function() {
                    ...
                    if ($(this).val() === 'all') {
                      ...
                      table3.column(4).search('^(?!.*\\bstock\\b)', true, false).draw();
                    } else {
                      table3.column(4).search(stock).draw();
                  ...
                  $('select#store').on('change', function() {
                    ...
                    if ($(this).val() === 'all') {
                      ...
                      table3.column(5).search(store).draw();
                    }
                  });
        ...
        ?>
          <div class="confirm_delete_page">
            <div class="custome-head">
              <h3>Are you sure to cancel order #<span class="order_id_confirm">...</span></h3>
        ...
        ?>
          <div class="invoice-page">
            <form action="" method="POST" class="inv-body" enctype="multipart/form-data">
              <div class="inv-head">
                <h2 class="inv-title">Invoice #
                  <input type="text" class="inv_number" name="inv_number" value=<?= get_supplier_order_number() ?> required />
                </h2>
                ...
                <div class="form-section">
                  <div class="inputs gd3">
                    ...
                    <input type="text" id="supplier" class="hand" name="supplier_name" value="<?php
                                                                                              ...
                                                                                              ?>" required disabled>
                    <input type="hidden" id="supplier_id" value="<?= $info['id'] ?>" name="supplier_id" required>
                  </div>
                  <div class="inputs gd2">
                    <label for="terms">Terms</label>
                    <select name="terms" id="terms" required>
                      <option value="dueonreceipt" selected>On receipt</option>
                  ...
                  <div class="inputs gd1 vat">
                    ...
                    <input type="number" name="vat" id="vat" min="0" value="0" step="0.01" required>
                  </div>
                  <div class="inputs gd3">
                  ...
                  <div class="inputs gd1">
                    ...
                    <input type="checkbox" name="storable" id="storable" checked>
                  </div>
              ...
              <div class="mid-form">
                <div class="employee-section request-section invoice-list">
                  <div class="request-list">
                    ...
                    <div class="request-body-list" id="inv-list">
                      <div class='request-row' id="row1">
                        ...
                        <div><input type="number" class="item_quantity1" name="p[1][quantity]" value="0" step="0.000001"></div>
                        <div><input type="text" class="item_unit1" name="p[1][unit]" disabled></div>
                        <div><input type="number" class="item_amount1" name="p[1][amount]" value="0" step="0.000001"></div>
                        <div><input type="number" class="item_total item_total1" name="p[1][total]" value="0" step="0.000001" disabled>
                        </div>
                        <div></div>
                      </div>
                    </div>
                  ...
                  <div class="bottom-list">
                    <div class="lt">
                      <div class="btns">
                        <button id="add-line"><i class="fa-solid fa-plus"></i> Add Line</button>
                      </div>
                      <div class="form-section">
                        <div class="inputs gd6">
                        ...
                        <div class="inputs gd6">
                          ...
                          <textarea name="statement" id="statement">فاتوره توريد مع اذن دفع مقدم</textarea>
                        </div>
                      </div>
                    </div>
                    <div class="rt">
                      ...
                      <div class="total-gd">
                        ...
                        <div class="total-value minus">E£ - <input type="number" name="discount" id="discount" value="0" step="0.00001"></div>
                      </div>
                      <!-- <div class="total-gd">
                        <div class="total-title withholding_title">Withholing Tax (1%)</div>
                      ...
                      <div class="total-gd">
                        ...
                        <div class="total-value">E£
                          <input type="number" name="paid" id="paid" value="0" step="0.00001">
        ...
        <div class="edit-invoice-page">
          <div class="inv-head">
            <h2 class="inv-title" id="order_title">Invoice #..</h2>
            <button id="close-btn" class="close"><i class="fa-solid fa-xmark"></i></button>
          </div>
        ...
        $(document).ready(function() {
          ...
          $(".inv_number").on('keyup', function() {
            ...
            if (inv_number == '') {
              ...
              $.ajax({
                type: "POST",
                url: "json/check_supp_invoice.php",
                data: {
                  inv_number,
                },
                dataType: "json",
          ...
          $("#inv_type").on("change", function() {
            if ($(this).val() == "1") {
              ...
              taxFactor = 0.05;
              withholdingTitle = "Withholing Tax (5%)";
            }
          ...
          $("#supplierpurch").on("click", ".re_order_btn", function() {
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                var finalVat = (rate * .14);
                var finalRate = (rate - finalWith + finalVat);
                $("#vat").val(14);
          ...
          $('#suppliertrans').on('click', 'button.view_purchase', function() {
            $.ajax({
              ...
              success: function(data) {
                $("#order_title").html("Invoice #" + data.order_id);
                $(".order_edit_id").val(data.order_id);
                $(".curr_name").html(data.supplier_name);
                $(".curr_status").html(data.status);
                $(".curr_vat_perc").html(data.vat_perc);
...
<?php
      ...
      header("location:" . $path . "/suppliers.php");
      exit();
    }
  } else {
    $path = (@$_SERVER["HTTPS"] == "on") ? "https://" : "http://";
