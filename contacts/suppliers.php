...
if (login_redirect() == 1) {
  ...
  if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(201) == 1) {
    ...
    <div class="att-part">
      <div class="title-head">
        <div class="headso">
          <h3>Suppliers</h3>
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Suppliers</p>
        </div>
        <div class="btns">
          ...
          <?php if (check_user_role(1) == 1 || check_user_role(200) == 1 || check_user_role(202) == 1) {
          ?>
            <button class="new-btn">New Supplier</button>
          <?php } ?>
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Customers</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
