...
if (login_redirect() == 1) {
  ...
  if (check_id('manufacturers')) {
    ...
    if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(303) == 1) {
      import_manufacure();
      edit_manufacturer_purchase();
      import_quick_manufacturer_payment();
      delete_order("manufacturer_orders");
?>
      ...
      <div class="att-part">
        ...
        <div class="profile-section">
          <div class="profile-head-box">
            ...
            <div class="rt-profile-head">
              <div class="buttons">
                <?php
                if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(304) == 1) {
                ?>
                ...
                <ul class="transactions-list">
                  <?php
                  if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(308) == 1) {
                  ?>
                    <li class="trans-option" id="invoice-btn">Manufacturing Order</li>
                  <?php } ?>
                  <?php
                  if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(309) == 1) {
                  ?>
          ...
          <ul class="profile-lnks customer">
            ...
            <?php
            if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(305) == 1) {
            ?>
              <li class="mony-lnk"><button id="mony-lnk">Account Statement</button></li>
            <?php } ?>
            <?php
            if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(306) == 1) {
            ?>
              <li class="transaction-lnk"><button id="transaction-lnk">Orders</button></li>
            <?php }
            ?>
            <?php
            if (check_user_role(1) == 1 || check_user_role(300) == 1 || check_user_role(307) == 1) {
            ?>
          ...
          ?>
            <div class="mony-list listo">
              <h4 class='submarin'>Manufacturer Account Statement
                <div class="inputs">
              ...
              <script>
                $(function() {
                  ...
                  $("#ExportReporttoPdf2").on("click", function() {
                    ...
                    printWindow.document.write('<html><head><title>' + $(".l-main-prof-info h2").html() + '\'s Orders [Manufacturer]</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
                    printWindow.document.write('<style>table td:last-child,table th:last-child {display: none;}</style>');
                    printWindow.document.write('<style>@page {size: A4 55% landscape;margin: 0;} </style>');
                    printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>' + $(".l-main-prof-info h2").html() + '\'s Orders [Manufacturer]</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
                    printWindow.document.write(barcodeDiv.innerHTML);
                    printWindow.document.write('</table><div class="sub_header"><span>Report was created at ' + currentTime + '</span><span>By ' + userDate + '</span></div><div class="copyright-section">© 2023 All rights reserved. Powered by <img src="../images/icon.png" alt="">onder</div></div></body></html>');
                  });
                  ...
                  $('#suppliertable').on('click', 'button.view_purchase', function() {
                    $.ajax({
                      ...
                      success: function(data) {
                        $("#order_title").html("Manufacturing Order #" + data.order_id);
                  ...
                  function printInvoice(invoiceId) {
                    ...
                    printWindow.document.write('</div>');
                    printWindow.document.write('<div class="invoice_table_head manu-list"><div class="request-row"><div>Name</div><div>Description</div><div>Qty.</div><div>Total (E£)</div></div></div>');

                    printWindow.document.write("<div class='manu-list invoice_table'>" + $('#inv-edit-list').html() + "</div>");
                ...
                $(function() {
                  ...
                  var table3 = $('#supplierpurch').DataTable({
                    ...
                    buttons: [{
                      ...
                      filename: $(".l-main-prof-info h2").html() + '\'s Manufactured Products', // Set the desired filename
                    }],
                    "lengthMenu": [
                      [10, 25, 50, 100, -1],
                      [10, 25, 50, 100, "All"]
                  ...
                  $("#ExportReporttoPdf3").on("click", function() {
                    ...
                    printWindow.document.write('<html><head><title>' + $(".l-main-prof-info h2").html() + '\'s Manufactured Products [Manufacturer]</title><link rel="stylesheet" href="styles/print.css"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet"><link href="//db.onlinewebfonts.com/c/0016f77f50d636d6eb6336a8a9d5d3d5?family=Felix+Titling" rel="stylesheet" type="text/css" />');
                    printWindow.document.write('<style>table td:last-child,table th:last-child {display: none;}</style>');
                    printWindow.document.write('<style>@page {size: A4 55% landscape;margin: 0;} </style>');
                    printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>' + $(".l-main-prof-info h2").html() + '\'s Manufactured Products [Manufacturer]</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
                    printWindow.document.write(barcodeDiv.innerHTML);
                    printWindow.document.write('</table><div class="sub_header"><span>Report was created at ' + currentTime + '</span><span>By ' + userDate + '</span></div><div class="copyright-section">© 2023 All rights reserved. Powered by <img src="../images/icon.png" alt="">onder</div></div></body></html>');
                  });
                  $('select#stock').on('change', function() {
                    ...
                    if ($(this).val() === 'all') {
                      ...
                      table3.column(4).search(stock, true, false).draw();
                    }
                  });
                  ...
                  <div class="request-list">
                    ...
                    <div class="request-body-list" id="inv-list">
                      <div class='request-row' id="row1">
                        ...
                        <div><input type="number" class="item_quantity1" name="p[1][quantity]" value="0" min="0" step="0.00000001"><span class="item_limit item_limit1" data-limit="0">/ -</span></div>
                        <div><input type="text" class="item_unit1" name="p[1][unit]" disabled></div>
                        <div><input type="number" class="item_amount1" name="p[1][amount]" value="0" min="0" step="0.00000001" disabled></div>
                        <div><input type="number" class="item_total item_total1" name="p[1][total]" value="0" min="0" step="0.00000001" disabled>
                        </div>
                        <div></div>
                      </div>
                      <div class='request-row'>
                        ...
                        <div></div>
                        <div></div>
                        <div><input type="number" class="serv_cost" name="serv_cost" value="0" step="0.00000001" required>
                        </div>
                        <div></div>
                      </div>
                    </div>
                  ...
                  <div class="bottom-list">
                    ...
                    <div class="rt">
                      ...
                      <div class="total-gd">
                        ...
                        <div class="total-value minus">E£ - <input type="number" name="discount" id="discount" value="0" step="0.0000001"></div>
                      </div>
                      <!-- <div class="total-gd">
                        <div class="total-title withholding_title">Withholing Tax (3%)</div>
                      ...
                      <div class="total-gd">
                        ...
                        <div class="total-value">E£
                          <input type="number" name="paid" id="paid" value="0" step="0.0000001">
        ...
        <div class="edit-invoice-page">
          <div class="inv-head">
            <h2 class="inv-title" id="order_title">Manufacturing Order #..</h2>
            <button id="close-btn" class="close"><i class="fa-solid fa-xmark"></i></button>
          </div>
          <form action="" method="POST" class="inv-body inv-edit-body" enctype="multipart/form-data">
            <div class="top-form">
              ...
              <div class="form-section">
                ...
                <div class="inputs gd1" style="display:none;">
        ...
        $(document).ready(function() {
          ...
          $("#code").on('keyup', function() {
            ...
            if (item_number == '') {
              ...
              $.ajax({
                type: "POST",
                url: "json/check_final_item_code.php",
                data: {
                  item_number,
                },
                dataType: "json",
          ...
          $(".inv_number").on('keyup', function() {
            ...
            if (inv_number == '') {
              ...
              $.ajax({
                type: "POST",
                url: "json/check_manu_invoice.php",
                data: {
                  inv_number,
                },
                dataType: "json",
