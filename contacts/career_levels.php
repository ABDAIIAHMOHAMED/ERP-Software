    ...
    <div class="att-part">
      <div class="title-head">
        <div class="headso">
          <h3>Career Levels</h3>
          <hr class="head-line">
          <p class="navigator"><a href="<?= $path ?>">Dashboard</a> / Career Levels</p>
        </div>
        ...
        ?>
          <div class="btns">
            ...
            <?php if (check_user_role(1) == 1 || check_user_role(500) == 1 || check_user_role(502) == 1) {  ?>
              <button class="new-btn">New Career Level</button>
            <?php } ?>
          </div>
        <?php
        }
      ...
      <div class="add_new new_account">
        <div class="custome-head">
          <h3>New Career Level</h3>
          <button class="close"><i class="fa-solid fa-xmark"></i></button>
        </div>
        <form class="" id="new_supplier" action="" method="POST">
          <input type="hidden" value="career_levels" name="type">
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#ExportReporttoPdf").on("click", function() {
          ...
          printWindow.document.write('</head><body><div class="container"><div class="header_container"><div class="lt-head"><h3>Career Levels</h3><span class="dt-range"></span></div><div class="rt-head"><div class="logo_img"><img src="../images/logo.png" alt="Company_logo" /></div></div></div><table>');
