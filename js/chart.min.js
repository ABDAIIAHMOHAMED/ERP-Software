...
!(function (t, e) {
  ...
  (Tn.id = "bar"), (Tn.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }), (Tn.overrides = { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
  class Ln extends Ls {
    initialize() {
      (this.enableOptionSharing = !0), super.initialize();
    }
  ...
  (En.id = "doughnut"),
    (En.defaults = { datasetElementType: !1, dataElementType: "arc", animation: { animateRotate: !0, animateScale: !1 }, animations: { numbers: { type: "number", properties: ["circumference", "endAngle", "innerRadius", "outerRadius", "startAngle", "x", "y", "offset", "borderWidth", "spacing"] } }, cutout: "50%", rotation: 0, circumference: 360, radius: "100%", spacing: 0, indexAxis: "r" }),
  ...
  (In.id = "polarArea"),
    (In.defaults = { dataElementType: "arc", animation: { animateRotate: !0, animateScale: !0 }, animations: { numbers: { type: "number", properties: ["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"] } }, indexAxis: "r", startAngle: 0 }),
    (In.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
  ...
  class Io extends Es {
    ...
    _drawArgs(t) {
      ...
      let r,
        ...
        h,
        c = 0;
      return this.isHorizontal() ? ((l = ut(a, i, n)), (h = e + t), (r = n - i)) : ("left" === o.position ? ((l = i + t), (h = ut(a, s, e)), (c = -0.5 * D)) : ((l = n - t), (h = ut(a, e, s)), (c = 0.5 * D)), (r = s - e)), { titleX: l, titleY: h, maxWidth: r, rotation: c };
    }
    draw() {
      const t = this.ctx,
        e = this.options;
